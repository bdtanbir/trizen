...
if(!function_exists('WC')){
    ...
    <li class="dropdown dropdown-minicart">
        ...
        <ul class="dropdown-menu" aria-labelledby="d-minicart">
            <li class="heading">
                <h4 class="st-heading-section"><?php echo esc_html__('Your Cart', 'trizen') ?></h4>
            </li>
            <?php
            ...
            if (!empty($items)):
                        ...
                        <div class="media">
                            <div class="media-left">
                                ...
                                if( has_post_thumbnail( $post_id ) ){
                                    // echo get_the_post_thumbnail( $post_id, 'thumbnail', array('class' => 'img-responsive media-object', 'alt' => TravelHelper::get_alt_image()) );
                            ...
                            <div class="media-body">
                                ...
                                <?php endif; ?>
                                <div class="price-wrapper"><?php echo __('Price', 'trizen') ?>:
                ...
                ?>
                <li class="cart-total">
                    <div class="sub-total"><?php echo __('Subtotal', 'trizen') ?> <span
                    ...
                    <a href="<?php echo add_query_arg(['action' => 'st-remove-cart', 'security' => wp_create_nonce('st-security')]); ?>"
                       class="btn btn-danger btn-full upper">
                        <?php echo __('Remove Cart', 'trizen') ?>
                    </a>
                    <a href="<?php echo esc_url(get_permalink( wc_get_page_id( 'checkout' ) )) ?>"
                       class="btn btn-green btn-full upper mt10"><?php echo __('Check Out', 'trizen') ?></a>
                </li>
            <?php
            else:
                ?>
                <div class="col-lg-12 cart-text-empty text-warning"><?php echo __('Your cart is empty', 'trizen'); ?></div>
            <?php
            endif;
            ?>
        </ul>
    ...
    <li class="dropdown dropdown-minicart">
        ...
        <ul class="dropdown-menu" aria-labelledby="d-minicart">
            <li class="heading">
                <h4 class="st-heading-section"><?php esc_html_e('Your Cart', 'trizen') ?></h4>
            </li>
            <?php
            if (check_cart()):
                $items = get_carts();
