...
if ( ! class_exists( 'WP_Trizen_Navwalker' ) ) {
	...
	class WP_Trizen_Navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			$classes = array( 'dropdown-menu-item' );
			/**
			...
			/*
			 * The `.dropdown-menu-item` container needs to have a labelledby
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
				$added_icon = '<span class="menu-plus-icon"></span>';
			} else {
				$added_icon = ' ';
			}

			$output .= $indent . '<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" ' . $class_names . '>'.$added_icon.' ';
