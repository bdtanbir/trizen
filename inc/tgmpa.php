 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Trizen for publication on ThemeForest
...
add_action( 'tgmpa_register', 'trizen_register_required_plugins' );
 ...
 */
function trizen_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'      => __('One Click Demo Import', 'trizen'),
			'slug'      => 'one-click-demo-import',
			'required'  => false,
		),
		// Contact Form 7
		array(
			'name'      => __('Contact Form 7', 'trizen'),
			'slug'      => 'contact-form-7',
			'required'  => false,
		),
		// Elementor
		array(
			'name'      => __('Elementor', 'trizen'),
			'slug'      => 'elementor',
			'required'  => false,
		),
		// Mailchimp for WordPress
		array(
			'name'      => __('Mailchimp for WordPress', 'trizen'),
			'slug'      => 'mailchimp-for-wp',
			'required'  => false,
		),
		// Mailchimp for WordPress
		array(
			'name'      => __('WooCommerce', 'trizen'),
			'slug'      => 'woocommerce',
			'required'  => false,
		),
	 ...
	 */
	$config = array(
		'id'           => 'trizen',                 // Unique ID for hashing notices for multiple instances of TGMPA.
